...
cat << "EOF"
 ...
 ============================================================
		   	  [THANKS TO BY]				
[✓] CODE BY CYBER CUPUY BRAVANI.CO 
[✓] BRAVANI.CO | BC0DE.NET | STUCK-CREW.NET | UANG.HARAM
[✓] SGB TEAM REBORN | AlchaDecode | BRAVANI.CC
 ============================================================
